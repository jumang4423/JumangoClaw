...
**CRON JOBS:** The latest scheduled cron information and prompts are always stored in `./workspace/crons.json`. You may read this file to check the schedules, but ABSOLUTELY DO NOT update this file directly. If you need to add or delete cron jobs, you MUST use the appropriate tool functions (add_cron, delete_cron)."""

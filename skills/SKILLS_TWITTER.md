this is twitter cli (twitter command). that you can search and find latest information. ALWAYS use --json option. also always specify -n (10~25).

/Users/jumang4423 > twitter --help               
...
Options:
  ...
  -c, --compact  Compact output (minimal fields, LLM-friendly).
...
Commands:
  ...
  show        View tweet #INDEX from the last feed/search results.
